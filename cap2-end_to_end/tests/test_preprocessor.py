...
from models import PreprocessingConfig, PreprocessingStats, PreprocessingResult
...
class TestDataPreprocessor:
    ...
    def test_download_from_gcs_success(self, preprocessing_config_dict, mock_gcs_client, sample_housing_data, monkeypatch):
    ...
    def test_download_from_gcs_file_not_found(self, preprocessing_config_dict, mock_gcs_client, monkeypatch):
    ...
    def test_download_from_gcs_api_error(self, preprocessing_config_dict, mock_gcs_client, monkeypatch):
        """Test download fails with GCS API error."""
        monkeypatch.setattr('preprocessor.storage.Client', lambda: mock_gcs_client['client'])

        mock_gcs_client['blob'].exists.return_value = True
        mock_gcs_client['blob'].download_as_bytes.side_effect = gcp_exceptions.GoogleAPIError("Download failed")
    ...
    def test_get_input_stats(self, preprocessing_config_dict, mock_gcs_client, sample_housing_data, monkeypatch):
    ...
    def test_handle_missing_values_drop(self, preprocessing_config_dict, mock_gcs_client, sample_housing_data, monkeypatch):
    ...
    def test_handle_missing_values_median(self, preprocessing_config_dict, mock_gcs_client, sample_housing_data, monkeypatch):
    ...
    def test_handle_missing_values_mean(self, preprocessing_config_dict, mock_gcs_client, sample_housing_data, monkeypatch):
    ...
    def test_handle_missing_values_mode(self, preprocessing_config_dict, mock_gcs_client, sample_housing_data, monkeypatch):
    ...
    def test_create_features_enabled(self, preprocessing_config_dict, mock_gcs_client, sample_housing_data, monkeypatch):
    ...
    def test_create_features_disabled(self, preprocessing_config_dict, mock_gcs_client, sample_housing_data, monkeypatch):
    ...
    def test_create_features_missing_columns(self, preprocessing_config_dict, mock_gcs_client, monkeypatch):
    ...
    def test_upload_to_gcs_success(self, preprocessing_config_dict, mock_gcs_client, sample_housing_data, monkeypatch):
    ...
    def test_upload_to_gcs_failure(self, preprocessing_config_dict, mock_gcs_client, sample_housing_data, monkeypatch):
    ...
    def test_run_success_with_median(self, preprocessing_config_dict, mock_gcs_client, sample_housing_data, monkeypatch, mock_mlflow):
    ...
    def test_run_success_with_drop(self, preprocessing_config_dict, mock_gcs_client, sample_housing_data, monkeypatch):
    ...
    def test_analyze_and_select_best_imputation(self, preprocessing_config_dict, mock_gcs_client, sample_housing_data, monkeypatch):
    ...
    def test_get_imputation_plots_with_analyzer(self, preprocessing_config_dict, mock_gcs_client, sample_housing_data, monkeypatch):
    ...
    def test_get_imputation_plots_without_analyzer(self, preprocessing_config_dict, mock_gcs_client, monkeypatch):
