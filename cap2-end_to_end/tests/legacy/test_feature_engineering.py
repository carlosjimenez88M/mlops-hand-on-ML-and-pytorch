...
from feature_engineer import FeatureEngineer, ClusterSimilarity
...
class TestFeatureEngineer:
    ...
    def test_download_from_gcs_success(self, sample_config, sample_housing_data, mock_gcs_client, monkeypatch):
    ...
    def test_upload_to_gcs_success(self, sample_config, sample_housing_data, mock_gcs_client, monkeypatch):
    ...
    def test_transform_data_success(self, sample_config, sample_housing_data, mock_gcs_client, monkeypatch):
    ...
    def test_transform_data_missing_target(self, sample_config, sample_housing_data, mock_gcs_client, monkeypatch):
