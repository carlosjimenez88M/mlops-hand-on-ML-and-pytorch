...
class TestDataDownloader:
    ...
    def test_download_to_memory_with_retry(self, download_config_dict, mock_gcs_client, monkeypatch):
    ...
    def test_download_to_memory_max_retries_exceeded(self, download_config_dict, mock_gcs_client, monkeypatch):
    ...
    def test_extract_if_compressed_tar_gz(self, download_config_dict, mock_gcs_client, monkeypatch, tmp_path):
    ...
    def test_extract_if_compressed_no_valid_file(self, download_config_dict, mock_gcs_client, monkeypatch, tmp_path):
    ...
    def test_get_file_stats_from_bytes_non_csv(self, download_config_dict, mock_gcs_client, monkeypatch):
    ...
    def test_get_csv_stats_success(self, download_config_dict, mock_gcs_client, monkeypatch, sample_housing_data):
